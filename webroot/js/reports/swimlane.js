 ...
 */
d3.json('/admin/shop/shop_orders/report_data/swimlane.json', function(errors, data) {
	$.each(data.items, function(k, v) {
		var t = v.start.split(/[- :]/);
		data.items[k].start = new Date(t[0], t[1]-1, t[2], t[3], t[4], t[5]);

		var t = v.end.split(/[- :]/);
		data.items[k].end = new Date(t[0], t[1]-1, t[2], t[3], t[4], t[5]);
	});
