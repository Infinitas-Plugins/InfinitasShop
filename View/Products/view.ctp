<div class="viewProduct">
	...
	<div class="info">
		<table cellspacing="0" cellpadding="0">
			<tr><th style="width:70px;"><?php echo __('Code'); ?>:</th><td><?php echo 'todo'; ?></td></tr>
			...
			?>
			<tr><th><?php echo __('Sales Unit'); ?>:</th><td><?php echo $product['Unit']['name']; ?></td></tr>
			<tr><th><?php echo __('Supplier'); ?>:</th><td><?php echo $product['Supplier']['name']; ?></td></tr>
			<tr><th><?php echo __('Rating'); ?>:</th><td><?php echo sprintf(__('%s out of %s'), $product['Product']['rating'], $product['Product']['rating_count']); ?></td></tr>
			<tr><th><?php echo __('Viewed'); ?>:</th><td><?php echo sprintf(__('%s times'), $product['Product']['views']); ?></td></tr>
			<tr><th><?php echo __('Updated'); ?>:</th><td><?php echo $this->Time->niceShort($product['Product']['modified']); ?></td></tr>
		</table>
