 ...
 * @param array $options the options for the behavior
 * 
 * @return void
 */
	public function setup(ShopProduct $Model, array $options = array()) {
 ...
 * @return array
 */
	public function _findPossibleSpecials(ShopProduct $Model, $method, $state, array $query, array $results = array()) {
		if($state == 'before') {
